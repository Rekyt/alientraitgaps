...
> Grenié M., Bruelheide H., Dawson W., Essl F., van Kleunen M., KÜhn I., Kref H., Pyšek P., Weigelt P., and Winter M.. Workflow for *Gaps in global non-native plant trait data and how to move forward*. Submitted. Online at https://doi.org/xxx/xxx [**Zenodo DOI to come**]

Please also cite the manuscript:

> Grenié M., Bruelheide H., Dawson W., Essl F., van Kleunen M., KÜhn I., Kref H., Pyšek P., Weigelt P., and Winter M.. *Gaps in global non-native plant trait data and how to move forward*. Submitted. [**EcoEvoRxiv DOI to come**]
