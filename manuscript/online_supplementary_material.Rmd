...
You can get more information on the workflow used in the manuscript by refering to its hosted version on GitHub: https://github.com/Rekyt/alientraitgaps, which is archived on Zenodo as: https://doi.org/10.5281/zenodo.13940200.

This document aims to provide some interactive figures to make easier exploration of the data produced in the paper.
