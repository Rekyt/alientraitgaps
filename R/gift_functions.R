    ...
    mutate(
      trait_cat =
        case_when(
          ...
          Trait2 == "Growth_form_2"            ~ "life_history",
          Trait2 == "Epiphyte_1"               ~ "life_history",
          Trait2 == "Epiphyte_2"               ~ "life_history",
          Trait2 == "Climber_1"                ~ "life_history",
          Trait2 == "Climber_2"                ~ "life_history",
          Trait2 == "Parasite_1"               ~ "life_history",
          Trait2 == "Plant_height_min"         ~ "height",
          Trait2 == "Plant_height_max"         ~ "height",
          Trait2 == "Plant_height_mean"        ~ "height",
          Trait2 == "Plant_height_measured"    ~ "height",
          Trait2 == "Aquatic_1"                ~ "life_history",
          Trait2 == "DBH_min"                  ~ "stem",
          Trait2 == "DBH_max"                  ~ "stem",
          Trait2 == "DBH_mean"                 ~ "stem",
          Trait2 == "DBH_measured"             ~ "stem",
          Trait2 == "Shoot_orientation"        ~ "stem",
          # Life-history traits
          Trait2 == "Lifecycle_1"              ~ "life_history",
          Trait2 == "Lifespan_1"               ~ "life_history",
          ...
          Trait2 == "Seed_length_max"          ~ "seed",
          Trait2 == "Seed_length_mean"         ~ "seed",
          Trait2 == "Seed_length_measured"     ~ "seed",
          Trait2 == "Seed_width_min"           ~ "seed",
          Trait2 == "Seed_width_max"           ~ "seed",
          Trait2 == "Seed_width_mean"          ~ "seed",
          Trait2 == "Seed_width_measured"      ~ "seed",
          Trait2 == "Seed_height_min"          ~ "seed",
          Trait2 == "Seed_height_max"          ~ "seed",
          Trait2 == "Seed_height_mean"         ~ "seed",
          Trait2 == "Seed_height_measured"     ~ "seed",
          Trait2 == "Fruit_length_min"         ~ "seed",
          Trait2 == "Fruit_length_max"         ~ "seed",
          Trait2 == "Fruit_length_mean"        ~ "seed",
          Trait2 == "Fruit_length_measured"    ~ "seed",
          Trait2 == "Fruit_width_min"          ~ "seed",
          Trait2 == "Fruit_width_max"          ~ "seed",
          Trait2 == "Fruit_width_mean"         ~ "seed",
          Trait2 == "Fruit_width_measured"     ~ "seed",
          Trait2 == "Fruit_height_min"         ~ "seed",
          Trait2 == "Fruit_height_max"         ~ "seed",
          Trait2 == "Fruit_height_mean"        ~ "seed",
          Trait2 == "Fruit_height_measured"    ~ "seed",
          Trait2 == "Fruit_type_1"             ~ "seed",
          Trait2 == "Dehiscence_1"             ~ "seed",
          Trait2 == "Fruit_dryness_1"          ~ "seed",
          Trait2 == "Seed_volume_min"          ~ "seed",
          Trait2 == "Seed_volume_max"          ~ "seed",
          Trait2 == "Seed_volume_mean"         ~ "seed",
          Trait2 == "Seed_volume_measured"     ~ "seed",
          Trait2 == "Seed_mass_min"            ~ "seed",
          ...
          Trait2 == "Inflorescence_length_min" ~ "flower",
          Trait2 == "Inflorescence_length_max" ~ "flower",
          Trait2 == "Flower_length_min"        ~ "flower",
          Trait2 == "Flower_length_max"        ~ "flower",
          Trait2 == "Flower_width_min"         ~ "flower",
          Trait2 == "Flower_width_max"         ~ "flower",
          Trait2 == "Dispersal_syndrome_1"     ~ "seed",
          Trait2 == "Dispersal_syndrome_2"     ~ "seed",
          ...
          Trait2 == "Fruiting_end"             ~ "seed",
          Trait2 == "Seeds_per_fruit"          ~ "seed",
          # Physiological Traits
          Trait2 == "SLA_min"                  ~ "leaf",
          Trait2 == "SLA_max"                  ~ "leaf",
          Trait2 == "SLA_mean"                 ~ "leaf",
          Trait2 == "SLA_measured"             ~ "leaf",
          Trait2 == "Carnivory"                ~ "life_history",
          Trait2 == "Leaf_form_1"              ~ "leaf",
          Trait2 == "Leaf_margin_1"            ~ "leaf",
          Trait2 == "Leaf_spines_1"            ~ "leaf",
          Trait2 == "Leaf_thorns_1"            ~ "leaf",
          Trait2 == "Leaf_arrangement"         ~ "leaf",
          Trait2 == "Succulence"               ~ "leaf",
          Trait2 == "Photosynthetic_pathway"   ~ "life_history",
          Trait2 == "SSD_min"                  ~ "stem",
          Trait2 == "SSD_max"                  ~ "stem",
          Trait2 == "SSD_mean"                 ~ "stem",
          Trait2 == "SSD_measured"             ~ "stem",
          Trait2 == "Leaf_size_min"            ~ "leaf",
          Trait2 == "Leaf_size_max"            ~ "leaf",
          Trait2 == "Leaf_size_mean"           ~ "leaf",
          Trait2 == "Leaf_size_measured"       ~ "leaf",
          Trait2 == "Nitrogen_fix_1"           ~ "root",
          Trait2 == "Leaf_length_min"          ~ "leaf",
          Trait2 == "Leaf_length_max"          ~ "leaf",
          Trait2 == "Leaf_length_mean"         ~ "leaf",
          Trait2 == "Leaf_length_measured"     ~ "leaf",
          Trait2 == "Leaf_width_min"           ~ "leaf",
          Trait2 == "Leaf_width_max"           ~ "leaf",
          Trait2 == "Leaf_width_mean"          ~ "leaf",
          Trait2 == "Leaf_width_measured"      ~ "leaf",
          Trait2 == "Leaf_thickness_min"       ~ "leaf",
          Trait2 == "Leaf_thickness_max"       ~ "leaf",
          Trait2 == "Leaf_thickness_mean"      ~ "leaf",
          Trait2 == "Leaf_thickness_measured"  ~ "leaf",
          Trait2 == "LDMC_min"                 ~ "leaf",
          Trait2 == "LDMC_max"                 ~ "leaf",
          Trait2 == "LDMC_mean"                ~ "leaf",
          Trait2 == "LDMC_measured"            ~ "leaf",
          # Genetical Traits
          Trait2 == "Chromosome_number"        ~ "life_history",
          Trait2 == "Ploidy_level"             ~ "life_history",
          # Ecological Traits
          Trait2 == "Elevational_range_min"    ~ NA_character_,
          Trait2 == "Elevational_range_max"    ~ NA_character_,
